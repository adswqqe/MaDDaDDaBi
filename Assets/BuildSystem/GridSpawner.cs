...
public class GridSpawner : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        for (int x = 0; x < xLength; x++)
        {
            ...
            {
                Vector3 pos = new Vector3(transform.position.x+x + 0.5f, transform.position.y, transform.position.z+z + 0.5f);//offset the x and z by 0.5 so the left and right sides of ground cube are at whole number intervals
